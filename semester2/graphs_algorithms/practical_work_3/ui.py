...
class UI:
    ...
    def lowest_cost_walk(self):
        ...
        vertex2 = input("the second vertex: ")
        try:
            (cost, prev) = self.graph.lowest_cost_path(int(vertex1), int(vertex2))
            print("the lowest cost walk between {} and {} is {}".format(int(vertex1), int(vertex2), cost))
            vertex1 = int(vertex1)
            vertex2 = int(vertex2)
            walk = []
            while vertex2 != vertex1:
                walk.append(vertex2)
                vertex2 = prev[vertex2]
            walk.append(vertex2)
            walk.reverse()
            print(walk)
    ...
    def print_menu():
        ...
        print("18. find the lowest cost walk between two given vertices.")
        print("0. exit")
