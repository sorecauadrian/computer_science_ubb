...
public class SelectWindow_Controller  implements Initializable
{
    ...
    private List<Statement> initialise_programs()
    {
        ...
        Statement sleep_statement=new CompoundStatement(new Variable_DeclarationStatement("v",new IntType()),
        new CompoundStatement(new AssignmentStatement("v",new ValueExpression(new IntValue(10))),
                new CompoundStatement(new ForkStatement(new CompoundStatement(new AssignmentStatement("v",new ArithmeticExpression(new VariableExpression("v"),new ValueExpression(new IntValue(1)),"-")),new CompoundStatement(new AssignmentStatement("v",new ArithmeticExpression(new VariableExpression("v"),new ValueExpression(new IntValue(1)),"-")),new PrintStatement(new VariableExpression("v"))))),
        ...
        statements_list.add(sleep_statement);
