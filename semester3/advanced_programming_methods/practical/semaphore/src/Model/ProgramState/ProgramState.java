...
public class ProgramState
{
    ...
    private MySemaphoreTable_Interface<Pair<Integer, List<Integer>>> semaphore_table;
    ...
    public ProgramState(Statement program)
    {
        ...
        this.semaphore_table=new MySemaphoreTable<>();
        this.id=1;

        this.execution_stack.push(program);
    }

    public ProgramState(MyStack_Interface<Statement> execution_stack, MyDictionary_Interface<String, Value> symbol_table, MyList_Interface<Value> output, MyDictionary_Interface<String, BufferedReader> file_table,MyHeap_Interface<Value> heap,Statement original_program,MySemaphoreTable_Interface<Pair<Integer, List<Integer>>> semaphore_table)
    {
    ...
    public MySemaphoreTable_Interface<Pair<Integer, List<Integer>>> get_semaphore_table()
    {
        return this.semaphore_table;
    }

    public void set_semaphore_table(MySemaphoreTable_Interface<Pair<Integer, List<Integer>>> semaphore_table)
    {
        this.semaphore_table = semaphore_table;
    }
