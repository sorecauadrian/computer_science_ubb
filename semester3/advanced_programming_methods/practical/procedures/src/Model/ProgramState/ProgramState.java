...
public class ProgramState
{
    ...
    private MyStack_Interface<MyDictionary_Interface<String,Value>> symbol_table_stack;
    ...
    public void set_procedure_table(MyProcedureTable_Interface<Pair<List<String>, Statement>> procedure_table)
    {
        this.procedure_table = procedure_table;
    }

    private MyProcedureTable_Interface<Pair<List<String>,Statement>> procedure_table;


    public MyProcedureTable_Interface<Pair<List<String>, Statement>> get_procedure_table() {
    ...
    public ProgramState(Statement program)
    {
       ...
       // this.symbol_table=new MyDictionary<String,Value>();
        this.symbol_table_stack=new MyStack<>();
        this.symbol_table_stack.push(new MyDictionary<String,Value>());
        this.output=new MyList<Value>();
        this.file_table=new MyDictionary<String, BufferedReader>();
        this.heap=new MyHeap<Value>();
        this.procedure_table=new MyProcedureTable<Pair<List<String>, Statement>>();
        this.id=1;

        this.execution_stack.push(program);
    }

    public ProgramState(MyStack_Interface<Statement> execution_stack, MyStack_Interface<MyDictionary_Interface<String, Value>> symbol_table_stack, MyList_Interface<Value> output, MyDictionary_Interface<String, BufferedReader> file_table,MyHeap_Interface<Value> heap,Statement original_program,MyProcedureTable_Interface<Pair<List<String>, Statement>> procedure_table)
    {
    ...
    {
        MyDictionary_Interface<String,Value> top_symbol_table_stack=this.symbol_table_stack.peek();
         return top_symbol_table_stack;
    }
    ...
    */
    public MyStack_Interface<MyDictionary_Interface<String, Value>> get_symbol_table_stack() {
        return this.symbol_table_stack;
    }

    public void set_symbol_table_stack(MyStack_Interface<MyDictionary_Interface<String, Value>> symbolTableStack) {
        this.symbol_table_stack = symbolTableStack;
    }
