...
public class MainWindow_Controller implements Initializable
{
    ...
    @FXML
    private TableView<Map.Entry<String, Pair<List<String>,Statement>>> procedures_table_view;
    @FXML
    private TableColumn<Map.Entry<String, Pair<List<String>,Statement>>,String> procedures_table_names;
    @FXML
    private TableColumn<Map.Entry<String, Pair<List<String>,Statement>>, String> procedure_table_concatenations;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        //new for procedures
        procedures_table_names.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue() + " "));
        procedure_table_concatenations.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue() + " "));
    ...
    private void change_program_state_handler(ProgramState current_program_state)
    {
        ...
        try
        {
            ...
            populate_procedures_table_view(current_program_state);
        }
        catch (Exception e)
        {
    ...
    private void populate_procedures_table_view(ProgramState program)
    {
        procedures_table_view.setItems(FXCollections.observableList(new ArrayList<>(program.get_procedure_table().get_content().entrySet())));
        procedures_table_view.refresh();
    ...
    private void populate_symbol_table_view(ProgramState program) throws Exception {
