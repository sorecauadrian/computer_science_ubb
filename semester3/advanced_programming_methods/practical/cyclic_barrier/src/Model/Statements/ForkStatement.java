...
public class ForkStatement implements Statement
{
    ...
    {
        return new ProgramState(new MyStack<>(),state.get_symbol_table().clone(),state.get_output(),state.get_file_table(),state.get_heap(),statement,state.get_barrier_table());
    }
