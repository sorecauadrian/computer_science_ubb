...
public class ProgramState
{
    ...
    private MyBarrier_Interface<Pair<Integer, List<Integer>>> barrier_table;
    ...
    public MyBarrier_Interface<Pair<Integer, List<Integer>>> get_barrier_table() {
        return this.barrier_table;
    }

    public void set_barrier_table(MyBarrier_Interface<Pair<Integer, List<Integer>>> barrier_table)
    {
        this.barrier_table = barrier_table;
    }
