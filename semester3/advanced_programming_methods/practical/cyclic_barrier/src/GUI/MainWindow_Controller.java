...
public class MainWindow_Controller implements Initializable
{
    ...
    //new additions for barrier
    @FXML
    private TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> barrier_table_view;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrier_table_indexes;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrier_table_values;
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrier_table_list;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        barrier_table_indexes.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getKey() + " "));
        barrier_table_list.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getValue() + " "));
        barrier_table_values.setCellValueFactory(p->new SimpleStringProperty(p.getValue().getValue().getKey() + " "));
    ...
    {
        barrier_table_view.setItems(FXCollections.observableList(new ArrayList<>(program.get_barrier_table().get_barrier_table().entrySet())));
