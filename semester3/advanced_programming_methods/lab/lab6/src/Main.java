...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        catch (InterpreterException exception) {System.out.println("1. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("2. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("3. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("4. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("5. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("6. " + exception.getMessage());}
        ...
        catch (InterpreterException exception) {System.out.println("7. " + exception.getMessage());}
